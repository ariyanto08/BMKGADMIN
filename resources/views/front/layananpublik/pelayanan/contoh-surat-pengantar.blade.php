                                ...
                                <div class="image-column col-md-10">
                                    ...
                                    <div class="item-tabs">
                                        ...
                                        <div class="tabs-content">
                                            @foreach ($surat->where('kategori','Contoh Surat Pengantar') as $item)
