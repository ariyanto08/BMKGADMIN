...
@endpush
<x-webase title="Cloud Type Wilayah Indonesia">
    @slot('breadcrumb')
        <x-template-web.bread-crumb.bread bread="Pengamatan" />
        <x-template-web.bread-crumb.bread bread="Citra Satelit" />
        <x-template-web.bread-crumb.crumb crumb="Cloud Type Wilayah Indonesia" />
    @endslot
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <section class="tabs-section" style="padding: 0%;">
                        <div class="auto-container">
                            <div class="row clearfix">
                                <h3 style="padding-left: 70px;">Cloud Type Wilayah Indonesia</h3><br>
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <img src="https://inderaja.bmkg.go.id/IMAGE/HCAI/CLC/HCAI_CLC_Indonesia.png" alt="">
                                </div>
                            </div>
                        </div>
                    </section>
