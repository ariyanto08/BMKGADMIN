                        ...
                        <div class="auto-container">
                            <div class="row clearfix">
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <img src="https://inderaja.bmkg.go.id/Radar/PANG_SingleLayerCRefQC.png?id=50951jdzqi1g3ienu9bq6n1" alt="">
                                </div>
                            </div>
                        </div>
                    </section>
