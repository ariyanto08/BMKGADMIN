            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <section class="tabs-section" style="padding: 0%;">
                        <div class="auto-container">
                            <div class="row clearfix">
                                <h3>Citra Satelit Kalimantan Barat</h3><br>
                                <br>
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <img src="https://inderaja.bmkg.go.id/IMAGE/HIMA/H08_EH_KALBAR.png" alt="">
                                </div>
                            </div>
                        </div>
                    </section>
