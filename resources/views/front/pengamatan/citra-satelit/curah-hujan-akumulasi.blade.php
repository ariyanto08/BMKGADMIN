                        ...
                        <div class="auto-container">
                            <div class="row clearfix">
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <img src="http://satelit.bmkg.go.id/IMAGE/GSMAP/GSMaP_Precipitation_24hr_update.png" alt="">
                                </div>
                            </div>
                        </div>
                    </section>
