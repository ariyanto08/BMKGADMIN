<x-webase title="Titik Panas Kalimantan Barat">
    @slot('breadcrumb')
        <x-template-web.bread-crumb.bread bread="Pengamatan" url="" />
        <x-template-web.bread-crumb.crumb crumb="Titik Panas Kalimantan Barat" />
    @endslot
                        ...
                        <div class="auto-container">
                            <div class="row clearfix">
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <img src="https://inderaja.bmkg.go.id/IMAGE/HOTSPOT/Hotspot_Kalbar.png" alt="">
                                </div>
                            </div>
                        </div>
                    </section>
