            ...
            <div class="sortable-masonry">
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns pull-right clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".Penghargaan"><span
                                class="txt">Penghargaan</span></li>
                        <li class="filter" data-role="button" data-filter=".Penerimaan Penghargaan"><span
                                class="txt">Penerimaan Penghargaan</span></li>
                        <li class="filter" data-role="button" data-filter=".Formetika"><span
                                class="txt">Formetika</span></li>
                        <li class="filter" data-role="button" data-filter=".Rekonsiliasi"><span
                                class="txt">Rekonsiliasi</span></li>
                        <li class="filter" data-role="button" data-filter=".Sosialisasi"><span
                                class="txt">Sosialisasi</span></li>
                    </ul>
                </div>
                <hr>
                <div class="items-container row clearfix">
                    ...
                    @foreach ($list_foto as $foto)
                        <div
                            class="col-lg-3 col-md-4 col-sm-6 col-xs-12 default-portfolio-item masonry-item all {{ $foto->kategori }}">
                            <div class="inner-box">
                                <figure style="max-height: 300px; overflow: hidden;" class="image-box"><img style="object-fit:cover;  width: 100%; height: 300px;"
                                        src="{{ url("public/$foto->gambar") }}" alt=""></figure>
                                <!--Overlay Box-->
                                <div class="overlay-one">
                                    <div class="overlay-inner">
                                        <div class="content">
                                            <a href="{{ url("public/$foto->gambar") }}" class="lightbox-image proj-link"
                                                target="_blank" title="{{ $foto->ket }}"><span
