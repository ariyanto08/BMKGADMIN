                        ...
                        <div class="auto-container">
                            <div class="row clearfix">
                                <div class="column content-column col-lg-11 col-md-12 col-sm-12">
                                    <span><h3>Prakiraan Curah Hujan Bulanan</h3></span><br>
                                    <!--Tabs Box-->
                                    <div class="tabs-box tabs-style-one">
                                        <!--Tab Buttons-->
                                        <ul class="tab-buttons clearfix">
                                            <li data-tab="#tab-two" class="tab-btn">PRAKIRAAN SIFAT HUJAN</li>
                                        </ul>

                                        <!--Tabs Content-->
                                        <div class="tabs-content active-tab" id="tab-two">
                                            <div class="images-box">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active">
                                                            <a href="#1a" data-toggle="tab">Bulan Ini</a>
                                                        </li>
                                                        <li><a href="#1b" data-toggle="tab">Bulan Depan</a>
                                                        </li>
                                                        <li><a href="#2b" data-toggle="tab">2 Bulan Kedepan</a>
                                                        </li>
                                                    </ul>
                                                <!--Tab / Active Tab-->
                                                <div class="tab-content ">
                                                    <div class="tab-pane active" id="1a">
                                                        <img src="https://iklim.kalbar.bmkg.go.id/images/klimat/peta-prakiraan-sifat-hujan-01.jpeg" alt="">
                                                    </div>
                                                    <div class="tab-pane" id="1b">
                                                        <img src="https://iklim.kalbar.bmkg.go.id/images/klimat/peta-prakiraan-sifat-hujan-02.jpeg" alt="">
                                                    </div>
                                                    <div class="tab-pane" id="2b">
                                                        <img src="https://iklim.kalbar.bmkg.go.id/images/klimat/peta-prakiraan-sifat-hujan-03.jpeg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
